...
$dateglobalize_2 = Text::_('FEBRUARY') . ' 10, 1372';
$dateformat_2    = 'F _ d , _ Y';

$dateglobalize_4 = Text::_('FEBRUARY') . ' 10';
$dateformat_4    = 'F _ d';

$dateglobalize_6 = Text::_('FEBRUARY') . ' 1372';
$dateformat_6    = 'F _ Y';

$dateglobalize_7 = Text::_('FRIDAY') . ' , _ ' . Text::_('FEBRUARY'). ' 10, 1372';
$dateformat_7    = 'l , _ F _ d , _ Y';

$dateglobalize_8 = Text::_('FRIDAY') . ' , _ ' . Text::_('FEBRUARY'). ' 10';
$dateformat_8    = 'l , _ F _ d';


$dmy_text_5 = '10␣' . Text::_('FEBRUARY') . '␣1372';
$dmy_text_6 = '10␣' . Text::_('FEBRUARY_SHORT') . '␣1372';

$mdy_text_5 = Text::_('FEBRUARY') . '␣10␣1372';
$mdy_text_6 = Text::_('FEBRUARY_SHORT') . '␣10␣1372';

$ymd_text_5 = '1372␣' . Text::_('FEBRUARY') . '␣10';
$ymd_text_6 = '1372␣' . Text::_('FEBRUARY_SHORT') . '␣10';
