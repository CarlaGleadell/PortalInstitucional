...
<?php if ( $doc->countModules('header') || $social_pos === 'header' || $navbar_search === 'header' || ( $data->params->get('offcanvas_style') && ($data->params->get('dialog_toggle') == 'header-start' || $data->params->get('dialog_toggle') == 'header-end') ) ) : ?>
...
<?php if ( $doc->countModules( 'navbar' ) || $navbar_search === 'navbar' || $social_pos === 'navbar' || $contact_pos === 'navbar' || ( $data->params->get('offcanvas_style') && ($data->params->get('dialog_toggle') == 'navbar-start' || $data->params->get('dialog_toggle') == 'navbar-end') ) ) : ?>
