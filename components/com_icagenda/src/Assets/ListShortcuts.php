...
use iCutilities\Event\EventData as icagendaEventData; // To be checked.
...
$EVENT_TITLE_HTAG        = (($this->params->get('headerList') < 3) && $this->params->get('show_page_heading')) ? 'h3' : 'h2';
...
// @todo Use RouteHelper::getListFilteredByCategoryRoute
 ...
 */
$onListAddEventInfo = JFactory::getApplication()->triggerEvent('onListAddEventInfo', array('com_icagenda.events', &$item, &$this->params));
