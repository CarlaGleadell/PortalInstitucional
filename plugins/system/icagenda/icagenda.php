...
/**
 *----------------------------------------------------------------------------
 * iCagenda     Plugin System
 *----------------------------------------------------------------------------
 * @version     1.1.0 2022-06-09
 *
 * @package     iCagenda.Plugin
 * @subpackage  System.icagenda
...
/**
 * iCagenda plugin class.
 */
class plgSystemIcagenda extends JPlugin
{
	/**
	 * Constructor.
	 *
			...
			&& version_compare(JVERSION, '4.1.0', 'ge'))
		{
			...
			{	
				$app->enqueueMessage('<h2>' . Text::_('COM_ICAGENDA_MSG_NEW_FUNCTIONALITY_LABEL') . '</h2>'
									...
									. '<div>'
									. '<a href="' . JRoute::_($thisURL.'&info_inlinehelp=-1') . '">'
	...
	public function onAfterInitialise()
	{
		...
		else
		{
			...
			$upgrade_menu_events = JComponentHelper::getParams('com_icagenda')->get('upgrade_menu_events');
			...
			if (!$upgrade_menu_events)
			{
				...
				JLog::add('iCagenda has updated menu links for List of Events. J3 "list" view converted to J4 "events" view', JLog::INFO, 'system-icagenda');
			}
		}
	}
	...
	public function onAfterDispatch()
	{
		...
		JHtml::_('stylesheet', 'media/com_icagenda/icicons/style.css', array('relative' => false, 'version' => 'auto'));
