...
//			JHtml::_('script', 'media/com_icagenda/leaflet/leaflet.js');
		...
		JHtml::_('styleSheet', 'media/com_icagenda/leaflet/plugins/search/leaflet-search.css');
		JHtml::_('script', 'media/com_icagenda/leaflet/plugins/search/leaflet-search.js');
		...
		JFactory::getDocument()->addScriptDeclaration("
			jQuery(document).ready(function($) {
				...
				if (tab) {
					$(tab).on('shown', function() {	// When tab is displayed...
						loadMap();
					});
				} else {
					loadMap();
