 ...
 */
class icagendaFormFieldDeadlineTime extends FormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		{
			$rowJ3        = '-fluid';
			$styleIconJ3  = ' style="display: inline-block; width: 10%;"';
			$styleFieldJ3 = ' style="display: inline-block; width: 30%;"';
			$styleInputJ3 = ' style="width:70%;"';
		}
		else
		{
			$rowJ3 = $styleIconJ3 = $styleFieldJ3 = $styleInputJ3 = '';
		}
...
//			'onchange="checkIsSet(this)"',
		...
		$html = '<div class="row' . $rowJ3 . ' ic-row">';

		$html.= '<div id="selectCal" class="col-2 col-xxxl-1' . $iconCalClass . '"' . $styleIconJ3 . '>';
		$html.= '<br /><span class="iCicon-calendar-days ic-fs-1-5 ms-2 mt-2"></span>';
		$html.= '</div>';

		$html.= '<div class="col-3 col-xxxl-2"' . $styleFieldJ3 . '>';
		$html.= '<label id="selectMonths-lbl" class="' . $monthClass . '">' . Text::_('IC_MONTHS') . '</label>';
		$html.= '<input id="selectMonths"'
				. ' class="input-deadline form-control ic-input-number-col-2' . $monthInput . '"' . $styleInputJ3
		...
		$html.= '<input id="selectWeeks"'
				. ' class="input-deadline form-control ic-input-number-col-2' . $weekInput . '"' . $styleInputJ3
		...
		$html.= '<input id="selectDays"'
				. ' class="input-deadline form-control ic-input-number-col-2' . $dayInput . '"' . $styleInputJ3
				. ' type="text" name="' . $this->name . '[day]" value="' . $value_day . '"'
				. implode(' ', $attributes) . '>';
		$html.= '</div>';

		$html.= '<div id="selectTime" class="col-2 col-xxxl-1' . $iconTimeClass . '"' . $styleIconJ3 . '>';
		...
		$html.= '<input id="selectHours"'
				. ' class="input-deadline form-control ic-input-number-col-2' . $hourInput . '"' . $styleInputJ3
		...
		$html.= '<input id="selectMinutes"'
				. ' class="input-deadline form-control ic-input-number-col-2' . $minInput . '"' . $styleInputJ3
