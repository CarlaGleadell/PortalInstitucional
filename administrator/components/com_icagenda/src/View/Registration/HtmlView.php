...
namespace WebiC\Component\iCagenda\Administrator\View\Registration;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		// Set Title
		ToolBarHelper::title($isNew ? 'iCagenda - ' . Text::_('COM_ICAGENDA_LEGEND_NEW_REGISTRATION')  : 'iCagenda - ' . Text::_('COM_ICAGENDA_LEGEND_EDIT_REGISTRATION'), $isNew ? 'new' : 'pencil-2');
		...
		{
			ToolBarHelper::apply('registration.apply', 'JTOOLBAR_APPLY');
...
//		}
		...
		{
			ToolBarHelper::cancel('registration.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
