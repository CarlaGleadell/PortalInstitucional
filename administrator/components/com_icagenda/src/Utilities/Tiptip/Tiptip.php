 ...
 * @subpackage  src.Utilities.Tiptip
...
class Tiptip
{
	...
	public static function setTooltip($selector = '.iCtip', $params = array())
	{
		...
		HTMLHelper::_('stylesheet', 'com_icagenda/tipTip.css', array('relative' => true, 'version' => 'auto'));
		HTMLHelper::_('script', 'com_icagenda/jquery.tipTip.js', array('relative' => true, 'version' => 'auto'));
